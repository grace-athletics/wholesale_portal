...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to My Glove Brand Portal</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          You've been invited to join the My Glove Brand wholesale portal. Click below to accept and create your account.
        </Text>
